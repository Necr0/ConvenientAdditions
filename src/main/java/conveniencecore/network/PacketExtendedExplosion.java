...
public class PacketExtendedExplosion extends PacketBase<PacketExtendedExplosion> {
	...
	public PacketExtendedExplosion onMessage(PacketExtendedExplosion message, MessageContext ctx) {
        ...
        Helper.getClientPlayer().motionX += (double)message.getMotionX();
        Helper.getClientPlayer().motionY += (double)message.getMotionY();
        Helper.getClientPlayer().motionZ += (double)message.getMotionZ();
		return null;
	}
