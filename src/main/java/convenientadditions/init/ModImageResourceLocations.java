...
public class ModImageResourceLocations {
	...
	public static final ImageResourceLocation PULSERS=new ImageResourceLocation(ConvenientAdditions.MODID+":textures/gui/common_atlas.png", 48, 48, 16, 16);
	public static final ImageResourceLocation AUTO=new ImageResourceLocation(ConvenientAdditions.MODID+":textures/gui/common_atlas.png", 32, 0, 16, 16);
}
