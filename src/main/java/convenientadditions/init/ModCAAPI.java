...
public class ModCAAPI {
    ...
    private static void initTome() {
        ...
        if (ModConfig.transmutationTome_oreDowngrade) {
            ...
            TransmutationTomeRecipeHandler.INSTANCE.addRecipe(new ItemStack(Blocks.EMERALD_ORE, 1), new ItemStack(Items.GLOWSTONE_DUST, 1), new ItemStack(Blocks.DIAMOND_ORE, 2), time_long, 5);
        }
