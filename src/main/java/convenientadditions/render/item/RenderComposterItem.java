...
public class RenderComposterItem implements IItemRenderer {
	...
	private ModelComposter modelComposter;
	
	public RenderComposterItem() {
		this.modelComposter=new ModelComposter();
	}
    ...
    private void renderFrameItem(RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
    {
        ...
        this.modelComposter.render((Entity) null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
        GL11.glPopMatrix();
        GL11.glPopMatrix();
    }
