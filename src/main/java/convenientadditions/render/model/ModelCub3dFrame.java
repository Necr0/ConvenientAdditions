...
/**
 * ModelCub3dFrame - Necr0
 * Created using Tabula 4.1.1
 */
public class ModelCub3dFrame extends ModelBase {
    ...
    public ModelCub3dFrame() {
        ...
        this.plateTop = new ModelRenderer(this, 0, 0);
        this.plateTop.setRotationPoint(-8.0F, 8.0F, -8.0F);
        this.plateTop.addBox(0.0F, 0.0F, 0.0F, 16, 1, 16, 0.0F);
        ...
        this.plateBottom = new ModelRenderer(this, 0, 0);
        this.plateBottom.setRotationPoint(-8.0F, 23.0F, -8.0F);
        this.plateBottom.addBox(0.0F, 0.0F, 0.0F, 16, 1, 16, 0.0F);
    }
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        this.plateTop.render(f5);
        this.pillar1.render(f5);
        this.plateBottom.render(f5);
    }
