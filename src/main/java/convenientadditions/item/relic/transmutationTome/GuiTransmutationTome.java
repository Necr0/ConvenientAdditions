...
public class GuiTransmutationTome extends CAGuiContainer {
    ...
    public void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (tcontainer.isRecipeValid()) {
            ...
            if(player.experienceLevel < tcontainer.getLevelRequired())
                this.drawCenteredString(this.fontRenderer, Helper.localize("gui."+ModConstants.Mod.MODID+":transmutationTome.insufficientXp"), leftX + 84, topY + 64, 0xFF1111);
