package convenientadditions.block.charge.chargeTube;
...
public class BlockChargeTube extends BlockMachine {
	...
	public BlockChargeTube() {
		super(Material.rock);
		this.setUnlocalizedName(ConvenientAdditions.MODID+":"+Reference.chargeTubeBlockName).setHardness(1F).setResistance(1F);
	}
